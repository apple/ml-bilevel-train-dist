...
def get_config():
    return ml_collections.ConfigDict({
        ...
        "specific_tsv": "data/pile_100k_pubmed_abstracts/train.txt",
        "specific_split": [
            0,
            10000,
            0,
        ...
        "eval_sets": [
            ...
            [
                "pubmed_abstracts",
                "data/pile_100k_pubmed_abstracts/valid.txt",
                false,
                2000
            ]
        ],
        ...
        "name": "c4lm_pubmed_abstracts soba downsampling=128 lr=0.00200",
        "tags": [
            "soba",
            "c4_pile_lm"
        ],
